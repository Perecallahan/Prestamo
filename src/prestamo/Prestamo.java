 ...
 * 
 * 
 * Valores borde 1000 y 15000 (deben ser válidos)
 * Valores para equivalencia: 500, 20000 (valores no validos) y 10000 (este es válido)
 * 
 * el programa funciona con int, así que no hay que tener en cuenta los decimales
 * 
 * 
 * normalmente, crearíamos una preuba básica, una before/after, una before/after class, 
 * una de parámetros y un suite de todos
 * 
 */
